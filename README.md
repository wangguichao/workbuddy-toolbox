...
- **可执行提示词**（5 条）：可直接复制给 AI 助手的指令，已含具体参数与路径
- **操作步骤**（5~10 步）：落到具体工具/方法（Python 库、软件、Windows 系统操作）的实施指南
...
3. 两种落地方式：
   - **让 AI 执行**：复制「可执行提示词」，粘贴给 Workbuddy 等 AI 助手。
   - **自行搭建**：按「操作步骤」安装环境、运行脚本，并可加入自己的自动化流程。
4. 落地过程中发现缺步骤、写错、或有更好的方法，欢迎提交 Issue 或 PR。
